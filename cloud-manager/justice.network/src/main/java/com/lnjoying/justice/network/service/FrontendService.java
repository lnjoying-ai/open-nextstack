...
public interface FrontendService extends IService<Frontend> {
    FrontendsRsp getFrontendServices(FrontendSearchCritical frontendCritical, String userId);

    FrontendBaseRsp addFrontend(FrontendCreateReq frontendInfo, @NotBlank String userId);

    FrontendBaseRsp delFrontend(@NotBlank String frontendId, String userId);

    FrontendBaseRsp updateFrontend(String frontendId,FrontendCreateReq frontendInfo, String userId);
}
