...
import com.lnjoying.justice.network.mapper.SubnetMapper;
 ...
 */
@Service
public class SubnetServiceImpl extends ServiceImpl<SubnetMapper, Subnet> implements SubnetService {
