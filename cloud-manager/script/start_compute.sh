...
HOME_OPT="$BASE_OPT -Dlog4j.configurationFile=$LOG_CFG_HOME/compute_log4j2.xml"
...
java $HOME_OPT $JAVA_OPTS $COMPUTE_RESOURCE_OPTS -jar ${BIN_HOME}/com.lnjoying.justice.compute.jar  1> /dev/null 2> ${LOG_OUT}/compute.out  &