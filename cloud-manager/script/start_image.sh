...
HOME_OPT="$BASE_OPT -Dlog4j.configurationFile=$LOG_CFG_HOME/image_log4j2.xml"
...
echo "******-----   start image      ----*******"
java $HOME_OPT $JAVA_OPTS $IMAGE_RESOURCE_OPTS -jar ${BIN_HOME}/com.lnjoying.justice.image.jar  1> /dev/null 2> ${LOG_OUT}/image.out  &
