...
HOME_OPT="$BASE_OPT -Dlog4j.configurationFile=$LOG_CFG_HOME/repo_log4j2.xml"
...
echo "******-----   start repo      ----*******"
java $HOME_OPT $JAVA_OPTS $IMAGE_RESOURCE_OPTS -jar ${BIN_HOME}/com.lnjoying.justice.repo.jar  1> /dev/null 2> ${LOG_OUT}/repo.out  &
