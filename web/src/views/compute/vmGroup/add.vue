    ...
    >
      <el-card class="!border-none mb-3">
        ...
        <div class="text item">
          <el-form-item :label="$t('common.name') + ':'" prop="name">
            <el-input v-model="form.name" class="!w-60" :placeholder="$t('compute.vmGroup.form.namePlaceholder')" />
          </el-form-item>
          <el-form-item :label="$t('common.description') + ':'" prop="description">
            <el-input
              ...
              type="textarea"
              :rows="2"
              :placeholder="$t('compute.vmGroup.form.descriptionPlaceholder')"
            />
          </el-form-item>
          <el-form-item :label="$t('compute.vmGroup.form.vm') + ':'" prop="description">
            ...
            >
              ...
              <el-table-column :label="$t('common.operation')" width="120">
                <template #default="scope">
                  <el-button type="text" :size="mainStoreData.viewSize.listSet" @click="toDelete(scope.$index)">
                    {{ $t('compute.vmGroup.remove') }}
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      <el-card class="!border-none mb-3">
        <div class="text item text-center">
          <el-button type="primary" @click="toVmGroupAdd()">{{ $t('common.createNow') }}</el-button>
        </div>
      </el-card>
    </el-form>
    <el-dialog
