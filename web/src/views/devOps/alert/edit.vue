  ...
  <div class="eipPoolAddPage h-full">
    ...
    >
      <el-card class="!border-none mb-3">
        ...
        <div class="text item">
          <el-form-item :label="$t('devOps.alert.name') + ':'" prop="name">
            <el-input v-model="form.name" class="!w-60" :placeholder="$t('devOps.alert.selectName')" />
          </el-form-item>
          <el-form-item :label="$t('devOps.alert.description') + ':'" prop="description">
            <el-input
              ...
              type="textarea"
              :rows="2"
              :placeholder="$t('devOps.alert.selectDescription')"
            />
          </el-form-item>
        </div>
      </el-card>
        ...
        <div class="text item">
          ...
          >
            <div v-if="form.resourceType == 0">
              ...
              >
                <el-table-column prop="date" :label="$t('devOps.alert.form.vmName')">
            ...
            <div v-if="form.resourceType == 1">
              ...
              >
                <el-table-column prop="name" :label="$t('devOps.alert.form.vmName')">
                  <template #default="scope">
            ...
            <div v-if="form.resourceType == 2">
              ...
              <el-table
                ...
                :scrollbar-always-on="false"
              >
                <el-table-column prop="date" :label="$t('devOps.alert.form.nodeName')">
                  <template #default="scope">
                    <!-- 新窗口打开 -->
      ...
      <el-card class="!border-none mb-3">
        ...
        <div class="text item">
          ...
          >
            ...
            <el-select v-model="form.durationTime" class="!w-30" :placeholder="$t('devOps.alert.selectDuration')">
              <el-option :label="'3' + $t('devOps.alert.minuteUnit')" :value="3" />
              <el-option :label="'5' + $t('devOps.alert.minuteUnit')" :value="5" />
              <el-option :label="'10' + $t('devOps.alert.minuteUnit')" :value="10" />
              <el-option :label="'15' + $t('devOps.alert.minuteUnit')" :value="15" />
              <el-option :label="'20' + $t('devOps.alert.minuteUnit')" :value="20" />
              <el-option :label="'30' + $t('devOps.alert.minuteUnit')" :value="30" />
              <el-option :label="'40' + $t('devOps.alert.minuteUnit')" :value="40" />
              <el-option :label="'50' + $t('devOps.alert.minuteUnit')" :value="50" />
              <el-option :label="'1' + $t('devOps.alert.hourUnit')" :value="60" />
            </el-select>
          </el-form-item>
          <el-form-item :label="$t('devOps.alert.alertInterval') + ':'" prop="interval">
            <el-select v-model="form.interval" class="!w-50" :placeholder="$t('devOps.alert.selectAlertInterval')">
              ...
              <el-option :label="'50' + $t('devOps.alert.minuteUnit')" :value="50" />
              <el-option :label="'1' + $t('devOps.alert.hourUnit')" :value="60" />
              <el-option :label="'2' + $t('devOps.alert.hourUnit')" :value="120" />
              <el-option :label="'3' + $t('devOps.alert.hourUnit')" :value="180" />
              <el-option :label="'4' + $t('devOps.alert.hourUnit')" :value="240" />
              <el-option :label="'12' + $t('devOps.alert.hourUnit')" :value="720" />
              <el-option :label="'24' + $t('devOps.alert.hourUnit')" :value="1440" />
            </el-select>
          </el-form-item>
          <el-form-item :label="$t('devOps.alert.alertLevel') + ':'" prop="level">
          ...
          <el-form-item v-if="form.notice" :label="$t('devOps.alert.form.noticeGroup') + ':'" prop="receiverListData">
            <div>
              ...
              <el-table
                ...
                :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
              >
                <el-table-column prop="name" :label="$t('devOps.alert.form.noticeName')">
                  <template #default="scope">
      ...
      <el-card class="!border-none mb-3">
        <div class="text item text-center">
          <el-button type="primary" @click="toalertAdd()">{{ $t('common.updateNow') }}</el-button>
        </div>
      </el-card>
    </el-form>
    <el-dialog
        ...
        <el-row :gutter="10">
          <el-col :span="24">
            ...
            >
              ...
              <el-table-column :label="$t('devOps.alert.form.computeNode.cpu')" prop="cpuLogCount">
                <template #default="scope">
              ...
              <el-table-column :label="$t('devOps.alert.form.computeNode.gpu')" prop="gpuTotal">
                <template #default="scope">
              ...
              <el-table-column :label="$t('devOps.alert.form.computeNode.memory')" prop="memTotal">
                <template #default="scope">
              ...
              <el-table-column :label="$t('devOps.alert.form.computeNode.ibNetwork')" prop="ibTotal">
                <template #default="scope">
