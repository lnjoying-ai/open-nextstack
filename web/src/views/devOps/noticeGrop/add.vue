    ...
    >
          ...
          <div v-for="(item, index) in form.contactInfos" :key="index">
            <el-form-item
              :label="
                index == 0
                  ? form.type == 0
                    ? $t('devOps.noticeGrop.form.email') + ':'
                    : $t('devOps.noticeGrop.form.phone') + ':'
                  : ''
              "
      ...
      <el-card class="!border-none mb-3">
        <div class="text item text-center">
          <el-button type="primary" @click="toNoticeGroupAdd()">{{ $t('common.createNow') }}</el-button>
        </div>
      </el-card>
    </el-form>
  </div>
