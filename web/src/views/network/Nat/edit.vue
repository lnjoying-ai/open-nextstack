  ...
  <div class="bmsAddPage h-full">
    ...
    >
      <el-card class="!border-none mb-3">
        ...
        <div class="text item">
          <el-form-item :label="$t('network.nat.form.name') + ':'" prop="name">
            <el-input v-model="form.name" class="!w-60" :placeholder="$t('network.nat.form.namePlaceholder')" />
          </el-form-item>
        </div>
      </el-card>
      ...
      <el-card class="!border-none mb-3">
        <div class="text item text-center">
          <el-button type="primary" @click="toFlavorsEdit()">{{ $t('common.update') }}</el-button>
        </div>
      </el-card>
    </el-form>
  </div>
